...
/// Tests for VoiceOverlayViewModel (Story 5.2) — Listening to Confirming flow.
///
/// Covers: listening → confirming, commit, correct, cancel, subset scoring,
/// VoiceOver focus pause, and auto-commit timer behavior (6.3–6.8).
@Suite("VoiceOverlayViewModel — Listening")
@MainActor
struct VoiceOverlayListeningTests {
