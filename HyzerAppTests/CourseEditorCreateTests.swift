...
/// Tests for CourseEditorViewModel — canSave, setHoleCount, and saveCourse (create mode) (Story 2.1 + 2.2).
@Suite("CourseEditorViewModel — Create")
@MainActor
struct CourseEditorCreateTests {
