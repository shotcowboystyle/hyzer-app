...
/// Tests for HistoryListViewModel card data derivation (Story 8.1: History List & Round Detail).
@Suite("HistoryListViewModel — Card Data")
@MainActor
struct HistoryListCardDataTests {
