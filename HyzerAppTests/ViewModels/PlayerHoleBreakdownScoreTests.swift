...
/// Tests for PlayerHoleBreakdownViewModel score computation, corrections, guests, and sorting
/// (Story 8.2: Player Hole-by-Hole Breakdown).
@Suite("PlayerHoleBreakdownViewModel — Scores")
@MainActor
struct PlayerHoleBreakdownScoreTests {
