...
/// Tests for DiscrepancyViewModel — resolve and badge behaviors (Story 6.1: Discrepancy Alert & Resolution Flow).
@Suite("DiscrepancyViewModel — Resolve")
@MainActor
struct DiscrepancyResolveTests {
